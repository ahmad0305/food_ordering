...
function send_email($email,$html,$subject){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="sheakhsarfraz0304@gmail.com";
	$mail->Password="yagqxoapmfipwfww";
	$mail->SetFrom("sheakhsarfraz0304@gmail.com");
...
function getOrderDetails($oid){
	global $con;
	$sql="select order_details.price,order_details.qty,dish_details.attribute,dish.dish,order_details.dish_details_id
...
function orderEmail($oid, $uid=''){
	...
	$total_price = $getOrderById[0]['total_price'];
								...
								<td colspan="2">
								  <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
									...
									foreach($getOrderDetails as $OrderDetails){
										...
										$price = $OrderDetails['price']*$qty;
										$dish = $OrderDetails['dish'];
										$attribute = $OrderDetails['attribute'];
										$totalPrice = $totalPrice+$price;
									$html.='<tr>
									  <td width="40%" class="purchase_item"><span class="f-fallback">'.$dish.'('.$attribute.')</span></td>
									  <td width="40%" class="purchase_item"><span class="f-fallback">'.$qty.'</span></td>
									...
									$html.='<tr>
									  ...
									  <td width="20%" class="purchase_footer" valign="middle">
										<p class="f-fallback purchase_total">'.$totalPrice.'</p>
									  </td>
									</tr>';
