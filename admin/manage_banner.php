...
if(isset($_POST['submit'])){
    ...
    if($id==''){
        ...
        if($type!='image/jpeg' && $type!='image/png'){
            ...
            mysqli_query($con,"insert into banner(heading,sub_heading,link,link_txt,status,added_on,order_number,image) values('$heading','$sub_heading','$link','$link_txt',1,'$added_on','$order_number','$image')");
            redirect('banner.php');
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control" placeholder="Image" name="image" <?php echo $image_status?> required>	
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="sub heading" name="sub_heading" required value="<?php echo $sub_heading;?>">                    </div>
                    <div class="form-group">
