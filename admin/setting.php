...
$cart_min_price=(!empty($row['cart_min_price']))? $row['cart_min_price']:"";
$cart_min_price_msg=(!empty($row['cart_min_price_msg']))? $row['cart_min_price_msg']:"";
$website_close=(!empty($row['website_close']))? $row['website_close']:"";
$website_close_msg=(!empty($row['website_close_msg']))? $row['website_close_msg']:"";
