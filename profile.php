                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="billing-info">
                                                                <label>Name</label>
                                                                <input type="text" id="uname" name="name" value="<?php echo $getUserDetailsByid['name']?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="billing-info">
                                                        ...
                                                        <div class="col-lg-12 col-md-12">
                                                            <div class="billing-info">
                                                                ...
                                                                <input type="email" value="<?php echo $getUserDetailsByid['email']?>" readonly="readonly">
                                                            </div>
                                                        </div>                                                                                                        
                                                    </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="billing-information-wrapper">
                                                ...
                                                <div class="billing-back-btn">
                                                    ...
                                                    <div class="billing-btn">
                                                        <button type="submit" id="password_submit">Continue</button>
                                                    </div>
                                                </div>
